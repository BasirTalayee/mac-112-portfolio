...
-   Why does the histogram become ineffective if the `binwidth` is too small (e.g. 5 feet)?  we don’t lump enough hikes together and lose track of the bigger picture trends
