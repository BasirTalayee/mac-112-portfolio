...
```{r}
#| fig-cap: "Temperature Comparison at 9am and 3pm by Location"

ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temperature at 9 AM",
       y = "Temperature at 3 PM", 
       title = "Temperature Comparison at 9am and 3pm by Location",
       color = "location")
```
...
#| fig-alt: "A set of overlapping density plots showing the distribution of 3pm temperatures in three different Australian locations. Each location has a different fill color."
...
```{r}
#| fig-cap: "Density plots of 3pm temperatures in 3 Australian locations."
#| fig-alt: "Overlapping density plots of 3pm temperatures in three Australian locations, each with a different color."
